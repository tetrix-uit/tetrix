...
\textbf{Mục tiêu cụ thể của nhóm:} hoàn thành trò chơi Tetrix chạy trên terminal
bằng C++17 theo đúng yêu cầu đề bài, đồng thời áp dụng một quy trình làm việc
chuyên nghiệp để mọi phần việc đều truy vết được.

\textbf{Phạm vi làm việc:}
...
Tài liệu kỹ thuật đầy đủ của dự án được xuất bản bằng Docusaurus. Các liên kết:
